                                    ...
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th id="label" class="text-center align-middle">Label (عربي)</th>
                                                <th id="label_eng" class="text-center align-middle">Label (English)</th>
                                                <th id="title" class="text-center align-middle">Title (عربي)</th>
                                                <th id="title_eng" class="text-center align-middle">Title (English)</th>
                                                <th id="description" class="text-center align-middle">Description (عربي)</th>
                                                <th id="description_eng" class="text-center align-middle">Description (English)</th>
                                                <th id="button_label" class="text-center align-middle">Button_label (عربي)</th>
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <button class="btn btn-warning text-white editBtn mb-1">
                                                        <i class="fa fa-edit"></i> edit
                                                    </button>
                                                    <button class="btn btn-danger text-white deleteBtn mb-1">
